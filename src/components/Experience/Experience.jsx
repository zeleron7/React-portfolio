    ...
    <div className={styles.experienceContainer}>
        ...
        <h2 className={styles.subtitle}>Internship, Region Gävleborg</h2>
         ...
         This project has been very educational and expanded my knowledge <br/> in system development as i got to work with both backend and frontend.</p>
          ...
          <p className={styles.experience}>Here i worked in a team with others and my task was to install and connect solar panels on various properties. <br/> 
          I worked on both small and large projects and had a lot of contact with other professional groups. <br/> 
          This has given me great experience in communication</p>
